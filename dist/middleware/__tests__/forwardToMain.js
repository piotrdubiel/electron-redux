...
describe('forwardToMain', function () {
  ...
  it('should pass an action through if it doesn\'t pass validation (FSA)', function () {
    ...
    (0, _forwardToMain2.default)(_transitImmutableJs2.default)()(next)(action);
  ...
  it('should forward any actions to the main process', function () {
    ...
    expect(_electron.ipcRenderer.send).toHaveBeenCalledWith('redux-action', _transitImmutableJs2.default.toJSON(action));
