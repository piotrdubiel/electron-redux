...
describe('replayActionMain', function () {
  it('should replay any actions received', function () {
    ...
    (0, _replayActionMain2.default)(store, _transitImmutableJs2.default);
    ...
    expect(store.dispatch).toHaveBeenCalledWith(_transitImmutableJs2.default.toJSON(payload));
  });
  ...
  it('should subscribe to the store and update the global state', function () {
    ...
    expect(global.reduxState).toEqual(_transitImmutableJs2.default.toJSON(initialState));
    ...
    expect(global.reduxState).toEqual(_transitImmutableJs2.default.toJSON(newState));
  });
});